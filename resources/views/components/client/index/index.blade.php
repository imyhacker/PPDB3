        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap mb-5">
                    ...
                    <img src="{{asset('cln/images/gambarku.jpeg')}}" class="img-fluid" style="border-radius: 5px;"
                        alt="">
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="font-weight-500">Ini adalah beberapa video video kegiatan sekolah yang telah dilakukan oleh
                    seluruh siswa dan guru SMK Telematika Indramayu</p>
                </p>
                <div class="row">
                    @forelse($vid as $v)
                    <div class="col-md-12 mt-3">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/{{$v->id_video}}?rel=0" allowfullscreen></iframe>
                        </div>
                    </div>
                    @empty
